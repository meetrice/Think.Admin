...
{	
	...
	public function getDataList($keywords, $page, $limit)
	{
		...
		$list = $this
				->where($map)
				->alias('user')
				->join('__OA_ADMIN_STRUCTURE__ structure', 'structure.id=user.structure_id', 'LEFT')
				->join('__OA_ADMIN_POST__ post', 'post.id=user.post_id', 'LEFT');
