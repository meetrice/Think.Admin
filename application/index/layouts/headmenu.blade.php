...
@if(Auth::user()->group_id == 1)
		<li class="user dropdown"><a class="dropdown-toggle" href="javascript:void(0)" title="{{ Lang::get('core.m_controlpanel') }}"  data-toggle="dropdown"><i class="icon-cog2"></i> <i class="caret"></i></a>
		  <ul class="dropdown-menu dropdown-menu-right icons-right">
			...
			<li><a href="{{ URL::to('core/posts')}}"><i class="icon-libreoffice"></i> {{ Lang::get('core.Posts_Articles_Blog')}}</a></li>
			<li><a href="{{ URL::to('core/forms')}}"><i class="icon-list2"></i> {{ Lang::get('core.Form_Generator')}}</a></li>
			
			<li class="divider"></li>
			<li><a href="{{ URL::to('sximo/module')}}"><i class="icon-spinner7"></i> {{ Lang::get('core.m_codebuilder') }}</a></li>
			<li><a href="{{ URL::to('sximo/code')}}"><i class="icon-pencil3"></i>  <span class="text-danger">{{ Lang::get('core.Source_Code_Editor') }}</span>  </a></li>
			<li><a href="{{ URL::to('sximo/tables')}}"><i class="icon-database"></i> {{ Lang::get('core.Database_Tables') }}</a></li>
			<li><a href="{{ URL::to('sximo/menu')}}"><i class="icon-paragraph-left2"></i> {{ Lang::get('core.m_menu') }}</a></li>	
			<li class="divider"></li>
			<li><a href="{{ url('core/template/changelog')}}"><i class="icon-feed3"></i> {{ Lang::get('core.Changelog') }} </a></li>
			<li><a href="{{ URL::to('core/template')}}"><i class="icon-table"></i> {{ Lang::get('core.Template_Guide') }}  </a></li>
			<li><a href="http://sximobuilder.com/faqs" target="_blank"><i class="icon-book"></i> {{ Lang::get('core.Online_Documentation') }} </a></li>
		...
		<li class="user dropdown"><a class="dropdown-toggle avatar" href="javascript:void(0)"  data-toggle="dropdown" title="{{ Lang::get('core.m_myaccount') }}">
		 ...
		 <i class="caret"></i></a>
		  <ul class="dropdown-menu dropdown-menu-right icons-right">
			...
			<li><a href="{{ URL::to('')}}" target="_blank"><i class="icon-earth"></i>  {{ Lang::get('core.Main_Site') }} </a></li>
			<li><a href="{{ URL::to('user/profile')}}"><i class="icon-bubble-user"></i> {{ Lang::get('core.m_profile') }}</a></li>
			<li><a href="{{ URL::to('core/elfinder')}}"><i class="icon-folder2"></i>  {{ Lang::get('core.File_Manager') }} </a></li>
